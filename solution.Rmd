...
Look at the "Files" pane on RStudio, where you can find "problem.Rmd". 
...
```{r, git-pane, fig.align='center', fig.cap='Git pane', echo=FALSE}
...
# Example: Matheamtical expressions using LaTeX
